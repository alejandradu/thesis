...
class Analyzer():
    def __init__(self, experiment_path, train_data_path, lightning_module):
    ...
    def load_best_model(self, metric='ptl/val_accuracy', mode='max'):
        ...
        # this loads a ckpt file (Lightning default)
        ...
        # BUG: potentially the best_checkpoint is in a list and has to be unpacked
        
        # model = self.lightning_module.load_from_checkpoint(best_checkpoint)
